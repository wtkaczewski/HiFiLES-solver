...
void calc_source_SA_2d(hf_array<double>& in_u, hf_array<double>& in_grad_u, double& d, double& out_source)
{
...
void calc_source_SA_3d(hf_array<double>& in_u, hf_array<double>& in_grad_u, double& d, double& out_source)
{
